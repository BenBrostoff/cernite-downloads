...
Try demo inside the app if you do not have supported local agent sessions. Demo controls cannot stop real work. Real stops require eligible, independently verified processes and native confirmation. A session sharing an app server cannot be stopped individually. Automated checks use simulated processes. Separate manual checks stopped a disposable Claude instance and froze/killed disposable Claude and Codex roots, with zero survivors. The targets were idle; this does not prove cancellation of remote model requests or an ongoing side effect. See the release notes for evidence and limits.
